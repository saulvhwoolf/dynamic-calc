...
function calculateSMSSSV(gen, attacker, defender, move, field) {
    ...
    else if (move.named('Natural Gift') && ((_a = attacker.item) === null || _a === void 0 ? void 0 : _a.includes('Berry'))) {
...
function calculateBPModsSMSSSV(gen, attacker, defender, move, field, desc, basePower, hasAteAbilityTypeChange, turnOrder, profile, ctx) {
    ...
    if (attacker.hasItem('Punching Glove') && move.flags.punch || attacker.hasItem('Kicking Shoes') && move.flags.kick ) {
        bpMods.push(4506);
        desc.attackerItem = attacker.item;
    }
